...
def baixar_videos_do_grupo():
    ...
    with TelegramClient(SESSION_FILE, API_ID, API_HASH) as client:
        ...
        try:
            ...
            mensagens = client.iter_messages(entidade_grupo, filter=InputMessagesFilterVideo)
            ...
            logger.info(f"Total de {total_videos} vídeos encontrados. Iniciando o download.")
